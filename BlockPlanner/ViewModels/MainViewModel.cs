...
namespace BlockPlanner.ViewModels
{
    public class MainViewModel : ViewModelBase
    {
        ...
        public MainViewModel(Scheduler scheduler)
        {
            ...
            Task testTask = new Task("TestowyTask", DateTime.Now, DateTime.Now.AddHours(1), (Color)ColorConverter.ConvertFromString("#86c676"), "AdditionalInfo");
            Task testTask2 = new Task("TestowyTask2", DateTime.Now.AddHours(1), DateTime.Now.AddHours(2), (Color)ColorConverter.ConvertFromString("#e5182b"), "AdditionalInfo");
            Task testTask3 = new Task("TestowyTask3", DateTime.Now.AddHours(3), DateTime.Now.AddHours(4), (Color)ColorConverter.ConvertFromString("#8800e6"), "AdditionalInfo");
